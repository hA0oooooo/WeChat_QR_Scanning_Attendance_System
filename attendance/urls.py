...
from .views import (
    ...
    qr_code_view, event_qr_code, scan_qr_page, event_detail
)
...
urlpatterns = [
    ...
    path('login/qr/', qr_code_view, name='qr_code'),
    
    # API接口
    path('api/scan-qr-code/', scan_qr_page, name='scan_qr_page'),
    ...
    path('teacher/leave/', leave_request_list, name='leave_request_list'),
    path('teacher/course/<str:course_id>/attendance/', manage_attendance_events, name='manage_attendance_events'),
    path('teacher/leave/<int:leave_request_id>/approve/', approve_leave_request, name='approve_leave_request'),
